...
@section('content')
    <div class="loading w-full h-full bg-black absolute left-0 top-0"></div>
    <div class="bg-white p-4 w-[30%]">
        ...
        <form class="flex flex-col">
            <input type="userName"
                class="pl-1 py-2 focus:ring-2 outline-none mt-1 mb-1 border rounded-sm text-sm id="userName"
                placeholder="Usernamee" name="Email" required>
            <input type="email" class="pl-1 py-2 focus:ring-2 outline-none mt-1 mb-1 border rounded-sm text-sm"
